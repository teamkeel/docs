...
const classes: Record<CalloutType, string> = {
  ...
  info: cn(
    "nx-border-blue-100 nx-bg-blue-100 nx-text-blue-900 dark:nx-border-blue-200/30 dark:nx-bg-blue-900/30 dark:nx-text-blue-200"
  ),
  warning: cn(
...
export function Callout({
  ...
  return (
    <div
      className={cn(
        "nextra-callout nx-overflow-x-auto nx-text-sm nx-mt-6 nx-flex nx-rounded-md nx-py-2 ltr:nx-pr-4 rtl:nx-pl-4",
