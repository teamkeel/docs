...
Let's navigate to the GraphQL playground by going to http://localhost:8000/api/graphiql(opens in a new tab).

Let's use it to create `User` from our data model at the application level. To do this, we'll run the following query:
