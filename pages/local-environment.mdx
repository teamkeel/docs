...
## VSCode Extension
The Keel [VSCode extension](https://marketplace.visualstudio.com/items?itemName=teamkeel.vscode-keel) provides inline validation, formatting, and syntax highlighting for Keel schema files. You can find the extension by searching for “Keel” in the Extensions tab in VSCode.

![Keel VSCode extension](/vscode-extension.png)

<Callout type="info" emoji="ℹ️">
  This extension only works in the desktop version of VS Code and not in the browser
</Callout>
