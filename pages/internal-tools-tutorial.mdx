...
In this tutorial we will create a simple interface to manage stock inventory. We will create 3 basic models with a Keel schema (a `Product`, `StockItem` and `StockLocation`), which will let a user:
1. list products
