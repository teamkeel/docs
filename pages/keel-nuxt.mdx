...
Keel utilizes a schema-driven approach to application development. This implies that all you need to construct a fully managed backend is to define a [schema](https://docs.keel.so/what-is-keel#schema) comprising data models, APIs, and permissions.
...
To use your Keel APIs in your Nuxt project, Keel can generate a fully type-safe API client based on your schema using the [Keel CLI](https://docs.keel.so/cli?utm_medium=blog&utm_id=demola).
