...
And it's _really_ easy.  Get your local project running, with `keel run`, go to https://console.keel.so/, and then choose the *Local project* option in your projects list.
