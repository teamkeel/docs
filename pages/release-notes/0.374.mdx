...
Up to now we have supported [creating nested records with built-in actions](/actions#creating-nested-records). We now support this with functions.
...
The following API request will create an author and a linked book record.
