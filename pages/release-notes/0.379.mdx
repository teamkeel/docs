...
We have made the move to NPM - [https://www.npmjs.com/package/keel](https://www.npmjs.com/package/keel). This does mean that we will no longer be updating the Homebrew tap with new versions of the CLI.
