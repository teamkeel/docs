...
Testing is built into the core of Keel. The testing package is generated from your project schema and gives full type safety for writing end-to-end tests against operations, custom functions, and jobs defined in your schema. 
