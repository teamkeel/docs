...
- permissions - have to defer for now because schema fails validation if you have both a schedule and a permission
- testing section needs love (and maybe moved to a dedicated section in the CLI section)
  -  could speak about test fixturing, and the exposed Vite assertions
  -  not sure if you VSCode debug this - because the node process is ephemeral
- say about using third party UI tool to look inside the test database
- code examples
- what you can do with the `ctx` argument
