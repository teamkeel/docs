...
A flow can be defined to accept inputs at start, whether optional or required. Flows support all of the standard Keel types. These inputs are available throughout each of the flow's execution runs.
