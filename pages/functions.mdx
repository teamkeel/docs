...
See [Model API](/docs/sdk/modelApi) for full usage.
...
If you need more complex database operations you can use the [Database API](/docs/sdk/databaseApi) to write custom queries.
