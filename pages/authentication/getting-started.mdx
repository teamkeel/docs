...
We currently support two flows of authenticating with third-party providers.
 ...
 - [**SSO Login:**](/authentication/flows/sso-login) *Done for you.* Use this flow if you want Keel to perform the complicated handshake with your preferred provider. 
