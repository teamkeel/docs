...
To build out the Document model for the application, we need to consider that based on our application requirement, a standalone user, user in a team, and a team can have a profile image document.
