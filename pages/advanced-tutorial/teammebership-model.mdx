...
The TeamMembership acts as a middleware between the Team and User models. Since Keel uses PostgreSQL for its database provisioning capabilities, think of this as a join table for a [many to many relationship](https://docs.keel.so/models#many-to-many-relationships) between the User and Team models.
