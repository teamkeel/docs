...
The TeamMembership acts as a middleware between the Team and User models. Since Keel uses PostgreSQL for its database provisioning capabilities, think of this as a join table for a many to many relationship between the User and Team models.

Following the same process we used to define our User model, we need to define the model fields and operations.
