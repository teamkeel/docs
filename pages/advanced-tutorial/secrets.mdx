...
From our custom function above, You can see that we are using secrets option pull the API credentials for our Cloudinary account.
...
To set your secrets in the Keel console, head over to **Environment Variables** on the side bar of the console. In the “Secrets” section of the page, please click on ”**add secrets**” and provide the secret name and value just like you did locally.
