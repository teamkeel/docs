...
<Callout type="info" emoji="ℹ️">
  Jobs in Keel have a max execution time of 15 minutes (due to Lambda max execution times). This time will be longer in the future
</Callout>
...
![Jobs on the left menu of the console](/jobs-sidebar.png)
