...
![Demo video](https://prod-files-secure.s3.us-west-2.amazonaws.com/ef7c2b80-6ed4-43fd-bf92-849a0817bb8b/90a234fe-17f0-4268-81f4-ab33ce270618/demo.mov)

<video autoPlay loop muted>
<source alt="project demo" src="/guide-demo.mov" type="video/mp4"/>
</video>

We have successfully built a simple backend for an application with Keel, set up Keel client package, set up authentication and consumed Keel-generated APIs in a NextJS application.
