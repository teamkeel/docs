...
Now that we have defined our schema, all we need to do is head over to the [Keel console](https://console.keel.so), create a new project by selecting a blank project in the Keel console and deploy our backend on Keel by making a push to the generated GitHub repository.
